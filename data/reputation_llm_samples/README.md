...
2. Copia su LLM correspondiente desde aquí:
   - `data/reputation_llm_samples/banking_bbva_retail_llm.json`
3. Pégalo en `data/reputation_llm/` con el mismo nombre:
   - `data/reputation_llm/banking_bbva_retail_llm.json`
